                    ...
                    <form action="{{ route('store.news') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <select name="category_id" id="inputState" class="form-select" required>
                            ...
                            <div class="mb-3 col-md-2">
                                ...
                                <select name="user_id" id="inputState" class="form-select" required>
                                    <option>Choose</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input name="news_title" type="text" required value="{{$sentnews->send_news_title}}" class="form-control" id="inputAddress">
                        </div>

                        <div class="mb-3">
                            <label for="example-textarea" class="form-label">News Description</label>
                            <textarea name="news_details" required class="form-control" id="example-textarea" rows="5">{{ $sentnews->send_news_details }}</textarea>
                        </div>

                        <div class="mb-3">
                            <label for="example-fileinput" class="form-label">Image</label>
                            <input type="file" name="image" required id="example-fileinput" class="form-control">
                        </div>

                        <div class="mb-3">
                            <label for="inputAddress" class="form-label">Tags</label>
                            <input name="tags" type="text" required class="form-control" id="inputAddress">
                        </div>
