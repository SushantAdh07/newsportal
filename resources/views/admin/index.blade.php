            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <a style="margin-bottom: 10px;" href="/" class="btn btn-primary">Home Page</a>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                    ...
                    <div class="widget-rounded-circle card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-end">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup">{{ count($news) }}</span>
                                        </h3>
                                ...
                                <div class="col-6">
                                    <div class="text-end">
                                        <h3 class="text-dark mt-1"><span
                                                data-plugin="counterup">{{ count($categories) }}</span></h3>
                    ...
                    <div class="widget-rounded-circle card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-end">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup">{{ $totalViews }}</span>
                                        </h3>
                                        <p class="text-muted mb-1 text-truncate">Views</p>
                                    </div>
                                </div>
                            </div> <!-- end row-->
                        </div>
